        ...
        <div className="LightDarkToggle scale-10 float-right" onClick={handleClick}>
            <div className="Frame1 w-[150px] h-[20.0px] relative bg-white bg-opacity-0">
              <div className="Group5 w-[693px] h-[300px] left-[27px] top-[50px] absolute">
                <div className={`Rectangle1 w-[400px] h-[300px] left-[143px] top-0 absolute transition-colors duration-300 ${isLightMode ? 'bg-blue-200' : 'bg-zinc-700'}`}/>
                <div className={`Ellipse1 w-[300px] h-[300px] left-[393px] top-0 absolute rounded-full transition-colors duration-300 ${isLightMode ? 'bg-blue-200' : 'bg-zinc-700'}`}/>
                <div className={`Ellipse2 w-[300px] h-[300px] left-0 top-0 absolute rounded-full transition-colors duration-300 ${isLightMode ? 'bg-blue-200' : 'bg-zinc-700'}`}/>
              </div>
              {!isLightMode && (
                <div className={`Group6 w-[229px] h-[216px] left-[386px] top-[88px] absolute ${isLightMode ? 'display-none' : ''}`}>
            ...
            {isLightMode && (
                <div className="Group8 origin-top-left w-[330px] h-[189px] left-[410px] top-[294px] absolute">
            ...
            <div className={`Ellipse3 w-[265px] h-[265px] left-[50px] top-[66px] absolute rounded-full transition duration-300 ${isLightMode ? 'bg-yellow-100 move-right' : 'bg-amber-50'}`} />
